...
The ingest app gathers posts with external links from configured sources and stores them in a local SQLite database.
...
- App config: `ingest/fetchlinks/data/config/config.json`
- Source config: `ingest/fetchlinks/data/config/sources.json`
