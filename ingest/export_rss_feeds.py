...
def render_snapshot(rows, generated_at: datetime) -> str:
    ...
    lines.append('# The DB is the live source of truth; this file is the seed/snapshot copy.')
    lines.append('# On the VM this file lives at /opt/fetchlinks/ingest/data/config/rss_feeds.txt.')
    lines.append('')
